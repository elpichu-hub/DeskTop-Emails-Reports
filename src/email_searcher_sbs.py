            ...
            if message_data[0] is not None and message_data[0][1] is not None:
                ...
                if file_paths:
                    try:
                        ...
                        sbs_generator.create_sbs(file_paths[0], email_address=email_address, team=team)
                        send_email_function.send_email(f'Success SBS', 'lazaro.gonzalez@conduent.com', f'SBS Sent Succesfully at {datetime.now()}')
                        print('sent SBS Successfully')
                    ...
                    send_email_function.send_email(f'SBS Missing File', 'lazaro.gonzalez@conduent.com', f'SBS Missing File {datetime.now()}')
